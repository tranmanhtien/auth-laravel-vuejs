    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="#layouts">
                        <i class="iconsminds-digital-drawing"></i> Roles
                    </a>
                </li>
                <li class="active">
                    <a href="#applications">
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#collapseProduct" aria-expanded="true"
                       aria-controls="collapseProduct" class="rotate-arrow-icon opacity-50">
                        <i class="simple-icon-arrow-down"></i> <span class="d-inline-block">Role</span>
                    </a>
                    <div id="collapseProduct" class="collapse show">
                        <ul class="list-unstyled inner-level-menu">
                            <li>
                                <a href="{{route('admin.role.index')}}">
                                    <i class="simple-icon-credit-card"></i> <span class="d-inline-block">List</span>
                                </a>
                            </li>
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#collapseAuthorization" aria-expanded="true"
                       aria-controls="collapseAuthorization" class="rotate-arrow-icon opacity-50">
                        <i class="simple-icon-arrow-down"></i> <span class="d-inline-block">Permission</span>
                    </a>
                            ...
                            <li>
                                <a href="{{ route('admin.permission') }}">
                                    <i class="simple-icon-user-following"></i> <span
                                        class="d-inline-block">List</span>
                                </a>
                            </li>
                        </ul>
                    </div>
